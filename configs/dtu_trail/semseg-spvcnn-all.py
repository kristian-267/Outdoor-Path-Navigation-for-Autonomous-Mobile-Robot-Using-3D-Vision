...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="RandomRotate", angle=[-1, 1], axis="y", center=[0, 0, 0], p=0.5),
            dict(type="RandomRotate", angle=[-1/32, 1/32], axis="x", p=0.5),
            dict(type="RandomRotate", angle=[-1/32, 1/32], axis="z", p=0.5),
            dict(type="RandomScale", scale=[0.9, 1.1]),
            dict(type="RandomShift", shift=((-0.2, 0.2), (-0.1, 0.1), (-0.2, 0.2))),
